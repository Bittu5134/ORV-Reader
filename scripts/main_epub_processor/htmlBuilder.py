    ...
    try:
        ...
        for index, line in enumerate(text):
            ...
            if line.startswith("<title>"):
                ...
                html.append(
                    f'<div class="orv_image"><img src="../../../assets/images/{line[0]}" alt="{html.escape(line[1])}" loading="lazy"></div>'
                )
            elif line == "":
                html.append(f"<br>")
            elif line == "***":
                ...
                template = template.replace(
                    r"{{COVER}}",
                    f'<div class="orv_cover"><img src="../../../assets/images/{urlparse.quote(line[0])}" alt="{html.escape(line[1])}"></div>',
                )
            else:
